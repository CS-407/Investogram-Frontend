...
const EditListPage = () => {
    ...
    const OtherStocks = () => {
        ...
        const otherStocks = allStocks?.filter((stock) => !currentListIds.includes(stock._id));
        return (
		...
		<div className="mx-16"> 
            <div className="flex justify-between">
                <div>
                    ...
                    <input type="text" className="block p-4 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500" value={list?.list_name} onChange={(e) => setList({...list, list_name: e.target.value})}/>
                </div>
