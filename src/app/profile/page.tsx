...
export default function profile() {
	return (
		<main className="">
			...
			<img src={"default_profile.png"} alt={`${"Username"}'s avatar`} className="w-48 h-48 rounded-full" />
			<h1 className="text-2xl font-bold mt-4">{"Username"}</h1>
			<div className="flex flex-row">
				<div className="text-gray-500 mt-2 w-1/2 p-1">{10} followers</div>
				<div className="text-gray-500 mt-2 w-1/2 p-1">{10} following</div>
			</div>
